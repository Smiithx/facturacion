		        ...
		        <div class="col-xs-9">
		            ...
		            <div class="tab-content">
		                ...
		                <div class="tab-pane" id="aseguradoras">
		                	...
		                	<a title="Agregar" data-toggle="modal" data-target="#modaledit" onclick="add_aseguradora()" data-placement="top" class="btn btn-primary pull-right aseguradoras">Nuevo</a>
		                	<br>
		                	<br>
