    ...
    <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" id="manual_servicio_editar_soat"
                   name="codigosoat" value="{{$manual_servicio->codigosoat}}">
        </div>
        <div class="form-group">
            <label for="costo">Costo:</label>
            <input required type="number" step="0.01" min="0" class="form-control" id="costo" name="costo"
                   value="{{$manual_servicio->costo}}">
        </div>
        <div class="form-group">
