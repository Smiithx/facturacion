...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover" id="tabla_manuales">
        <caption class="text-center">
            {!! Form::open(['route' => 'manuales.show', 'method' => 'GET', 'class' => 'container-fluid text-left', 'role' => 'search']) !!}
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <a title="Agregar" href="/manuales/{{$manual->id}}/servicios/create"  class="btn btn-primary servicios">Agregar</a>
                </span>
            </div>
            {!! Form::close() !!}
            <br>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="acciones">    
                    <a href="/manuales/{{$manual->id}}/servicios/{{$servicio->id}}/edit" class="btn btn-success" data-toggle='tooltip' title='Editar'>
